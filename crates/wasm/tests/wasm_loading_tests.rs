...
wasm_test!(load_simple_if_wasm, "simple_if.wasm");
...
wasm_test!(load_nested_loop_wasm, "nested_loop.wasm");
wasm_test!(load_sha256_wasm, "sha256.wasm");
wasm_test!(load_bitwise_wasm, "bitwise.wasm");

        ...
        ExecutionBundle {
            ...
            operands: [
                ...
                Some(DataAccess {
                    ...
                    prev_value: M31::from(42),
                    value: M31::from(0), // 42 - 42 = 0
                }),
            ],
        },
        // Test case 3: a = a - b (in-place subtraction with different operand)
        ExecutionBundle {
            registers: cairo_m_common::State {
                pc: M31::from(2),
                fp: M31::from(300),
            ...
            operands: [
                ...
                Some(DataAccess {
                    ...
                    prev_value: M31::from(100),
                    value: M31::from(70), // 100 - 30
                }),
            ],
        },
        // Test case 4: with negative offsets and modular arithmetic
        ExecutionBundle {
            registers: cairo_m_common::State {
                pc: M31::from(3),
                fp: M31::from(400),
            ...
            operands: [
                ...
                Some(DataAccess {
                    ...
                    prev_clock: M31::from(0),
                    prev_value: M31::from(0),
                    value: M31::from(5) - M31::from(10), // 5 - 10 in M31 field
                }),
            ],
        },
    ];

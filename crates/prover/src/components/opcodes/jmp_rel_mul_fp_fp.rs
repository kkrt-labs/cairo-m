//! This component is used to prove the JmpRelMulFpFp opcode.
...
//!   * `opcode_id - 28`
//! * read op0
//!   * `- [fp + off0, op0_prev_clk, op0_val]`
//!   * `- [clk - op0_prev_clk - 1]` in `RangeCheck_20` relation
//! * read op1
//!   * `- [fp + off1, op1_prev_clk, op1_val]`
...
impl Claim {
    ...
    /// Writes the trace for the JmpRelMulFpFp opcode.
    ///
    /// # Important
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpRelMulFpFp));

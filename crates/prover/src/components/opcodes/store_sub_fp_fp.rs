...
//!   * `[fp + off2, clk, op0 - op1]` in `Memory` relation with multiplicity enabler*mult
...
use crate::utils::opcodes::store_sub_fp_fp::PackedExecutionBundle;
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                *lookup_data.memory[3] =
                    [fp + off2, clock, op0_val - op1_val, zero, zero, zero, mult];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::StoreSubFpFp));

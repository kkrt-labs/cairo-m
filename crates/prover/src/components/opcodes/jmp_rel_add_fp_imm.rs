//! This component is used to prove the JmpRelAddFpImm opcode.
//! jmp rel [fp + off0] + imm
//!
//! # Columns
//!
...
//!   * `- [pc, fp] + [pc + op0_val + off1, fp]` in `Registers` relation
...
impl Claim {
    ...
    /// Writes the trace for the JmpRelAddFpImm opcode.
    ///
    /// # Important
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                *lookup_data.registers[1] = [pc + op0_val + off1, input.fp];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpRelAddFpImm));
        ...
        eval.add_to_relation(RelationEntry::new(
            &self.registers,
            E::EF::from(enabler.clone()),
            &[pc.clone() + op0_val.clone() + off1.clone(), fp.clone()],
        ));

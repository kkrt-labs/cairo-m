...
//!   * `- [pc, inst_prev_clk, opcode_id, off0, zero, off2] + [pc, clk, opcode_id, off0, zero, off2]` in `Memory` relation
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                *lookup_data.memory[0] = [input.pc, inst_prev_clock, opcode_id, off0, zero, off2];
                *lookup_data.memory[1] = [input.pc, clock, opcode_id, off0, zero, off2];

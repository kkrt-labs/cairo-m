...
use crate::utils::opcodes::store_mul_fp_imm::PackedExecutionBundle;
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::StoreMulFpImm));
        ...
        // Opcode id is StoreMulFpImm
        eval.add_constraint(enabler.clone() * (opcode_id.clone() - expected_opcode_id));

        // Multiplication constraint: dst_val - op0_val * off1 = 0
        eval.add_constraint(enabler.clone() * (dst_val - op0_val.clone() * off1.clone()));

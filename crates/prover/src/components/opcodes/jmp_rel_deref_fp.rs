//! This component is used to prove the JmpRelDerefFp opcode.
//! jmp rel [fp + off0]
//!
//! # Columns
//!
...
//!   * `- [pc, fp] + [pc + op0_val, fp]` in `Registers` relation
...
use crate::utils::opcodes::jmp_rel_deref_fp::PackedExecutionBundle;
...
impl Claim {
    ...
    /// Writes the trace for the JmpRelDerefFp opcode.
    ///
    /// # Important
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                *lookup_data.registers[1] = [pc + op0_val, input.fp];
...
impl InteractionClaim {
    ...
    pub fn write_interaction_trace(
        ...
        // Process all 2 memory lookups together
        let mut col = interaction_trace.new_col();
        (
            col.par_iter_mut(),
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpRelDerefFp));
        ...
        eval.add_to_relation(RelationEntry::new(
            &self.registers,
            E::EF::from(enabler.clone()),
            &[pc.clone() + op0_val.clone(), fp.clone()],
        ));
        ...
        eval.add_to_relation(RelationEntry::new(
            &self.memory,
            -E::EF::from(enabler.clone()),
            &[fp + off0, op0_prev_clock.clone(), op0_val],
        ));

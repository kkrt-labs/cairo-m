//! This component is used to prove the JmpRelMulFpImm opcode.
//! jmp rel [fp + off0] * imm
//!
//! # Columns
//!
...
impl Claim {
    ...
    /// Writes the trace for the JmpRelMulFpImm opcode.
    ///
    /// # Important
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpRelMulFpImm));

...
//! [fp + off2] = [fp + off0] - imm : StoreSubFpImm (deprecated - compiler uses Add with negated imm)
//! [fp + off2] = [fp + off0] * imm : StoreMulFpImm
//! [fp + off2] = [fp + off0] / imm : StoreDivFpImm (deprecated - compiler uses Mul with inverse imm)
//!
//! # Columns
//!
//! - enabler

//! This component is used to prove the JnzFpFp opcode.
...
use crate::utils::opcodes::jnz_fp_fp_taken::PackedExecutionBundle;
...
impl Claim {
    ...
    /// Writes the trace for the JnzFpFpTaken opcode.
    ///
    /// # Important

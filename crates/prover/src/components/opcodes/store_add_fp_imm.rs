...
//!   * `+ [fp + off2, clk, op0_val + off1]` in `Memory` Relation
...
use crate::utils::opcodes::store_add_fp_imm::PackedExecutionBundle;
...
impl InteractionClaim {
    ...
    pub fn write_interaction_trace(
        ...
        // Memory lookup for dst write with range check
        let mut col = interaction_trace.new_col();
        (
            col.par_iter_mut(),
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::StoreAddFpImm));

//! This component is used to prove the StoreAddFpImm opcode.
//! [fp + off2] = [fp + off0] + imm
//!
//! # Columns
//!
...
impl Claim {
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        let m31_instruction_size = PackedM31::from(M31::from(
            Instruction::size_in_m31s_for_opcode(STORE_ADD_FP_IMM).unwrap(),
        ));
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                let opcode_constant = PackedM31::from(M31::from(STORE_ADD_FP_IMM));
                ...
                *lookup_data.memory[10] = [fp + off2, dst_prev_clock, dst_prev_val];
                *lookup_data.memory[11] = [fp + off2, clock, op0_val + off1];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let opcode_constant = E::F::from(M31::from(STORE_ADD_FP_IMM));

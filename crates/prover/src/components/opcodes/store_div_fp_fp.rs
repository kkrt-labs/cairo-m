//! This component is used to prove the StoreDivFpFp opcode.
...
impl Claim {
    ...
    /// Writes the trace for the StoreDivFpFp opcode.
    ///
    /// # Important
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        let m31_instruction_size = PackedM31::from(M31::from(
            Instruction::size_in_m31s_for_opcode(STORE_DIV_FP_FP).unwrap(),
        ));
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        // Division constraint: dst_val * op1_val - op0_val = 0
        eval.add_constraint(
            enabler.clone() * (dst_val.clone() * op1_val.clone() - op0_val.clone()),
        );
        ...
        eval.add_to_relation(RelationEntry::new(
            &self.relations.memory,
            E::EF::from(enabler.clone()),
            &[pc + one + one + one, clock.clone(), off2.clone()],
        ));

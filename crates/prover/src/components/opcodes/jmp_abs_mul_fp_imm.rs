//! This component is used to prove the JmpAbsMulFpImm opcode.
...
impl Claim {
    ...
    /// Writes the trace for the JmpAbsMulFpImm opcode.
    ///
    /// # Important
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpAbsMulFpImm));

...
//!   * `[fp + off2, clk, op0_deref_val]` in `Memory` relation with multiplicity enabler*mult
...
use crate::utils::opcodes::store_double_deref_fp::PackedExecutionBundle;
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                let op0_deref_prev_clock = input.op1_prev_clock;
                let op0_deref_val = input.op1_val;
                ...
                *lookup_data.memory[1] =
                ...
                // Read [op0 + off1] - single lookup with multiplicity 1
                ...
                *lookup_data.memory[3] =
                    [fp + off2, clock, op0_deref_val, zero, zero, zero, dst_mult];
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(i, (writer, memory2, memory3))| {
                // memory2 is op0_deref read, memory3 is dst write
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::StoreDoubleDerefFp));
        ...
        // Opcode id is StoreDoubleDerefFp
        ...
        // Read [op0 + off1] (double dereference) - single lookup
        eval.add_to_relation(RelationEntry::new(
            &self.memory,
            -E::EF::from(enabler.clone()),
            &[

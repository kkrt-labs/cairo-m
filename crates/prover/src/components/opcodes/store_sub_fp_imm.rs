//! This component is used to prove the StoreSubFpImm opcode.
...
use cairo_m_common::instruction::STORE_SUB_FP_IMM;
...
impl Claim {
    ...
    /// Writes the trace for the StoreSubFpImm opcode.
    ///
    /// # Important
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                let opcode_constant = PackedM31::from(M31::from(STORE_SUB_FP_IMM));
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let opcode_constant = E::F::from(M31::from(STORE_SUB_FP_IMM));

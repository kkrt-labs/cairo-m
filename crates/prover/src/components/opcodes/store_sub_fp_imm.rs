...
use crate::utils::opcodes::store_sub_fp_imm::PackedExecutionBundle;
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(i, (writer, memory2, range_check_20_0))| {
                ...
                let num = PackedQM31::from(enabler_col.packed_at(i) * memory2[6]);
        ...
        (
            ...
            .for_each(|(_i, (writer, range_check_20_1, range_check_20_2))| {
                ...
                let denom_0: PackedQM31 = range_check_20_relation.combine(&[*range_check_20_1]);
                let denom_1: PackedQM31 = range_check_20_relation.combine(&[*range_check_20_2]);

//! This component is used to prove the JmpAbsMulFpFp opcode.
...
//!   * `- [pc, fp] + [op0_val * op1_val, fp]` in `Registers` relation
...
impl Claim {
    ...
    /// Writes the trace for the JmpAbsMulFpFp opcode.
    ///
    /// # Important
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                *lookup_data.registers[1] = [op0_val * op1_val, input.fp];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpAbsMulFpFp));
        ...
        eval.add_to_relation(RelationEntry::new(
            &self.registers,
            E::EF::from(enabler.clone()),
            &[op0_val.clone() * op1_val.clone(), fp.clone()],
        ));

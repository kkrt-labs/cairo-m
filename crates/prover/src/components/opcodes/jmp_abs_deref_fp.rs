...
//!   * `- [pc, fp] + [op0_val, fp]` in `Registers` relation
...
use crate::utils::opcodes::jmp_abs_deref_fp::PackedExecutionBundle;
...
impl Claim {
    ...
    /// Writes the trace for the JmpAbsDerefFp opcode.
    ///
    /// # Important
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                *lookup_data.registers[1] = [op0_val, input.fp];
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(i, (writer, memory0, memory1))| {
                let num_0 = -PackedQM31::from(enabler_col.packed_at(i));
                let denom_0: PackedQM31 = memory_relation.combine(&memory0[..6]);
                let num_1 = -PackedQM31::from(enabler_col.packed_at(i));
                let denom_1: PackedQM31 = memory_relation.combine(&memory1[..6]);

                let numerator = num_0 * denom_1 + num_1 * denom_0;
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpAbsDerefFp));

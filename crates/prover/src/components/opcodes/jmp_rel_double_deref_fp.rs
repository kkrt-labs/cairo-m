//! This component is used to prove the JmpRelDoubleDerefFp opcode.
...
//!   * `- [pc, fp] + [pc + op0_deref_val + off1, fp]` in `Registers` relation
...
//! * read [op0]
//!   * `- [op0_val, op0_deref_prev_clk, op0_deref_val] + [op0_val, clk, op0_deref_val]`
...
impl Claim {
    ...
    /// Writes the trace for the JmpRelDoubleDerefFp opcode.
    ///
    /// # Important
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                *lookup_data.registers[1] = [pc + op0_deref_val + off1, input.fp];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let expected_opcode_id = E::F::from(M31::from(Opcode::JmpRelDoubleDerefFp));
        ...
        // Opcode id is JmpRelDoubleDerefFp
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            E::EF::from(enabler.clone()),
            &[
                pc.clone() + op0_deref_val.clone() + off1.clone(),
                fp.clone(),
            ],
        ));

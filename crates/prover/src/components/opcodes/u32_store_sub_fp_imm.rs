...
//!   * `- [fp + dst_off, dst_prev_clk, dst_prev_val_lo] + [fp + dst_off, clk, op0_val_lo + borrow_lo << 16 - imm_lo]` in `Memory` Relation
//!   * `- [fp + dst_off + 1, dst_prev_clk, dst_prev_val_hi] + [fp + dst_off + 1, clk, op0_val_hi - borrow_lo + borrow_hi << 16 - imm_hi]` in `Memory` Relation
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        (
            ...
            .for_each(|(row_index, (mut row, input, lookup_data))| {
                ...
                let res_lo = op0_val_lo + borrow_lo * m31_16_shift - imm_lo;
                let res_hi = op0_val_hi - borrow_lo + borrow_hi * m31_16_shift - imm_hi;
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let res_lo = op0_val_lo.clone() + borrow_lo.clone() * m31_16_shift.clone() - imm_lo.clone();
        let res_hi = op0_val_hi.clone() - borrow_lo.clone() + borrow_hi.clone() * m31_16_shift
            - imm_hi.clone();

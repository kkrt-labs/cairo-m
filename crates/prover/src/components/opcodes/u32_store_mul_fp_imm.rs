...
impl InteractionClaim {
    ...
    pub fn write_interaction_trace(
        ...
        (
            col.par_iter_mut(),
            &interaction_claim_data.lookup_data.range_check_16[6],
            &interaction_claim_data.lookup_data.range_check_16[7],
        )
            .into_par_iter()
            .enumerate()
            .for_each(|(_i, (writer, range_check_16_0, range_check_16_1))| {
        ...
        (
            col.par_iter_mut(),
            &interaction_claim_data.lookup_data.range_check_16[8],
            &interaction_claim_data.lookup_data.range_check_16[9],
        )
            .into_par_iter()
            .enumerate()
            .for_each(|(_i, (writer, range_check_16_0, range_check_16_1))| {

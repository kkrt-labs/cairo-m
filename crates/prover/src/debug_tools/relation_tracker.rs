...
fn relation_entries(
    ...
    let entries: Vec<RelationTrackerEntry> = chain!(
        ...
        add_to_relation_entries(&opcodes.double_deref_fp_imm, trace),
        add_to_relation_entries(&opcodes.double_deref_fp_fp, trace),
        ...
        add_to_relation_entries(&opcodes.store_le_fp_imm, trace),
        add_to_relation_entries(&opcodes.u32_store_add_fp_imm, trace),
        add_to_relation_entries(&opcodes.u32_store_add_fp_fp, trace),
        ...
        add_to_relation_entries(&opcodes.u32_store_bitwise_fp_fp, trace),
        add_to_relation_entries(&opcodes.u32_store_bitwise_fp_imm, trace),
        ...
        add_to_relation_entries(ch, trace),
        add_to_relation_entries(maj, trace),
        ...
        add_to_relation_entries(bitwise, trace),
    )
    .collect();

...
const STATE_FILE_NAME: &str = ".CairoMlings-state.txt";
...
impl AppState {
    ...
    #[inline]
    pub const fn current_exercise_ind(&self) -> usize {
    ...
    #[inline]
    pub const fn n_done(&self) -> u16 {
        self.n_done
    }

    #[inline]
    pub const fn n_pending(&self) -> u16 {
    ...
    #[inline]
    pub const fn cmd_runner(&self) -> &CmdRunner {
        &self.cmd_runner
    }

    #[inline]
    pub const fn emit_file_links(&self) -> bool {
